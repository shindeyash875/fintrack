...
export const EmptyState = ({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center p-8 sm:p-12 text-center rounded-2xl bg-white dark:bg-slate-900/60 border border-dashed border-slate-300 dark:border-slate-700"
    >
