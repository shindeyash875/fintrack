  ...
  return (
    ...
    >
      <div className="space-y-5">
        {/* Header Description */}
        <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-indigo-500/10 border border-emerald-500/20 text-slate-700 dark:text-slate-300">
          <div className="p-2 rounded-xl bg-white dark:bg-slate-800 shadow-sm border border-emerald-200 dark:border-emerald-800">
            <Sparkles className="w-5 h-5 text-emerald-600 dark:text-emerald-400 animate-pulse" />
          </div>
          <div className="text-xs leading-relaxed">
            <span className="font-semibold text-slate-900 dark:text-white">AI Vision OCR:</span> Upload a photo of a restaurant bill, grocery receipt, or 
            <strong className="text-emerald-700 dark:text-emerald-400"> Google Pay / PhonePe / Paytm</strong> payment screenshot to auto-extract details!
          </div>
        </div>
        ...
        {!selectedFile && (
          <div
            ...
            className="group cursor-pointer relative flex flex-col items-center justify-center p-8 rounded-2xl border-2 border-dashed border-slate-300 dark:border-slate-700 hover:border-emerald-500 bg-slate-50/70 dark:bg-slate-800/50 hover:bg-emerald-50/40 dark:hover:bg-emerald-950/20 transition-all duration-200 text-center"
          >
            <input
              ref={fileInputRef}
              type="file"
            ...
            />
            <div className="p-4 rounded-2xl bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 group-hover:scale-110 group-hover:border-emerald-300 dark:group-hover:border-emerald-600 transition-all duration-200 mb-3">
            ...
            <div className="mt-4 flex items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 shadow-2xs">
        ...
        {selectedFile && (
          <div className="space-y-4">
            <div className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-900/5 dark:bg-slate-950/40 max-h-56 flex items-center justify-center">
              <img
                src={previewUrl}
                alt="Receipt Preview"
            ...
            {scanError && (
              <div className="p-3.5 rounded-xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/50 flex items-start gap-2.5 text-xs text-rose-700 dark:text-rose-300">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-rose-800 dark:text-rose-200">Scanning failed</p>
                  <p className="mt-0.5">{scanError}</p>
                </div>
                <button
                  type="button"
                  onClick={() => processScan(selectedFile)}
                  className="inline-flex items-center gap-1 font-medium text-rose-800 dark:text-rose-300 hover:underline"
                >
            ...
            {/* Extracted Data Card */}
            {extractedData && (
              <div className="p-4 rounded-2xl bg-white dark:bg-slate-800/90 border border-emerald-500/30 dark:border-emerald-500/20 shadow-sm space-y-3">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-2.5">
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 text-slate-700 dark:text-slate-200 capitalize font-medium">
                  ...
                  <div className="col-span-2">
                    ...
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200 mt-1">
