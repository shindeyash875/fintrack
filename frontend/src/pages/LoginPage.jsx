...
import { Wallet, Mail, Lock, Eye, EyeOff, Loader2, AlertCircle, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center z-10">
        ...
        <h2 className="text-3xl font-extrabold text-white tracking-tight font-['Outfit']">
          Welcome back to <span className="text-emerald-400">FinTrack</span>
        </h2>
        <p className="mt-2 text-sm text-slate-400">
          Sign in to manage your expenses, categories, and monthly budgets
        </p>
      </div>
